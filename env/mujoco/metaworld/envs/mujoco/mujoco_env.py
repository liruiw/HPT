...
class MujocoEnv(gym.Env, abc.ABC):
    ...
    def __init__(self, model_path, frame_skip):
        ...
        self.metadata = {"render.modes": ["human"], "video.frames_per_second": int(np.round(1.0 / self.dt))}
    ...
    def render(self, offscreen=False, camera_name="corner2", resolution=(640, 480)):
        ...
        if not offscreen:
            ...
            return self.sim.render(*resolution, mode="offscreen", camera_name=camera_name)
