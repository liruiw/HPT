...
class SawyerPegUnplugSideEnvV2(SawyerXYZEnv):
    ...
    def evaluate_state(self, obs, action):
        ...
        reward, tcp_to_obj, tcp_open, obj_to_target, grasp_reward, in_place_reward, grasp_success = self.compute_reward(
            action, obs
        )
    ...
    def compute_reward(self, action, obs):
        ...
        return reward, tcp_to_obj, tcp_opened, obj_to_target, object_grasped, in_place, float(grasp_success)
