...
class SawyerFaucetCloseEnv(SawyerXYZEnv):
    def __init__(self):
        ...
        self.init_config = {"obj_init_pos": np.array([0, 0.8, 0.05]), "hand_init_pos": np.array([0.0, 0.6, 0.2])}
    ...
    def _target_site_config(self):
        return [("goal_close", self._target_pos), ("goal_open", np.array([10.0, 10.0, 10.0]))]
